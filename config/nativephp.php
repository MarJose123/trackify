...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.marjose.trackify.app'),
     ...
     * nativephp://some/path
     */
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'trackify'),
    ...
    'updater' => [
        ...
        'providers' => [
            'github' => [
                'driver' => 'github',
                'repo' => env('GITHUB_REPO', 'trackify'),
                'owner' => env('GITHUB_OWNER', 'marjose123'),
